...
Recomendar outfit segun temperatura, lluvia y tipo de evento.
...
1. Crear prendas por categoria.
2. Evaluar clima.
3. Filtrar prendas recomendadas.
4. Crear outfit final.
...
```text
intermedio/ejercicios/42-outfit-clima/resoluciones/juan-perez/juan-perez.js
```
