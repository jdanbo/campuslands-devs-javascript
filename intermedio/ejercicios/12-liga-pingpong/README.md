...
Crear tabla de liga con victorias, derrotas, puntos a favor y contra.
...
1. Modelar partidos jugados.
2. Calcular tabla por jugador.
3. Ordenar por puntos y diferencia.
4. Mostrar campeon provisional.
...
```text
intermedio/ejercicios/12-liga-pingpong/resoluciones/juan-perez/juan-perez.js
```
