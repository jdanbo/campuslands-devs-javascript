...
agrupacion y seleccion por rol

## Contexto

Armar una composicion MOBA equilibrada segun roles, dificultad y sinergia.
...
1. Crear heroes con rol, dificultad y sinergias.
2. Agrupar heroes por rol.
3. Validar que el equipo tenga 5 roles distintos.
4. Calcular una puntuacion de composicion.
...
```text
intermedio/ejercicios/04-rotacion-moba/resoluciones/juan-perez/juan-perez.js
```
