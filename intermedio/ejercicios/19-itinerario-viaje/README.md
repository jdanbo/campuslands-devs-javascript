...
Organizar actividades por fecha, costo y prioridad durante un viaje.
...
1. Crear actividades con fecha y costo.
2. Ordenar cronologicamente.
3. Calcular presupuesto total.
4. Detectar dias sobrecargados.
...
```text
intermedio/ejercicios/19-itinerario-viaje/resoluciones/juan-perez/juan-perez.js
```
