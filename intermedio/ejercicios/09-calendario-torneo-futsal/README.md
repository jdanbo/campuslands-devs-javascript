...
Crear un calendario simple donde todos los equipos se enfrenten una vez.
...
2. Generar emparejamientos sin repetir.
3. Asignar jornada a cada partido.
4. Validar que no haya partido contra si mismo.
...
```text
intermedio/ejercicios/09-calendario-torneo-futsal/resoluciones/juan-perez/juan-perez.js
```
