...
Administrar misiones bloqueadas por nivel o prerequisitos.
...
1. Crear misiones con prerequisitos.
2. Filtrar misiones disponibles.
3. Completar una mision.
4. Desbloquear nuevas misiones.
...
```text
intermedio/ejercicios/53-misiones-rpg/resoluciones/juan-perez/juan-perez.js
```
