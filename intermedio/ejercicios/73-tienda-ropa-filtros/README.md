...
Filtrar productos por talla, color, precio y categoria.
...
```text
intermedio/ejercicios/73-tienda-ropa-filtros/resoluciones/juan-perez/juan-perez.js
```
