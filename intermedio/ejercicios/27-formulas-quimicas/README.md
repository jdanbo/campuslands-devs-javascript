...
Analizar formulas simples para contar elementos y cantidades.
...
1. Recibir formulas como H2O, CO2, NaCl.
2. Extraer simbolos y cantidades simples.
3. Calcular conteo por elemento.
...
```text
intermedio/ejercicios/27-formulas-quimicas/resoluciones/juan-perez/juan-perez.js
```
