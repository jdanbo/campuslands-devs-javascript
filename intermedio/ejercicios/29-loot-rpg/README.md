...
Simular recompensas segun rareza y nivel de mazmorra.
...
1. Crear tabla de loot.
2. Asignar pesos por rareza.
3. Simular una recompensa.
4. Registrar historial de drops.
...
```text
intermedio/ejercicios/29-loot-rpg/resoluciones/juan-perez/juan-perez.js
```
