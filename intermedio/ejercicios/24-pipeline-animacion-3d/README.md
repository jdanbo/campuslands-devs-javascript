...
Controlar tareas de modelado, rigging, animacion, render y entrega.
...
1. Modelar assets con etapas.
2. Calcular progreso por asset.
3. Filtrar tareas bloqueadas.
4. Generar reporte por departamento.
...
```text
intermedio/ejercicios/24-pipeline-animacion-3d/resoluciones/juan-perez/juan-perez.js
```
