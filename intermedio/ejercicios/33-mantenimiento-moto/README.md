...
reglas por kilometraje

## Contexto

Recomendar mantenimiento segun kilometraje, uso y sintomas reportados.
...
1. Crear reglas de mantenimiento.
2. Evaluar kilometraje actual.
3. Cruzar sintomas con servicios.
...
```text
intermedio/ejercicios/33-mantenimiento-moto/resoluciones/juan-perez/juan-perez.js
```
