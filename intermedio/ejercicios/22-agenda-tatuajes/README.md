...
Gestionar citas de tatuajes por artista, duracion, zona y deposito.
...
1. Crear citas.
2. Validar disponibilidad por artista.
3. Calcular pago pendiente.
4. Listar agenda por fecha.
...
```text
intermedio/ejercicios/22-agenda-tatuajes/resoluciones/juan-perez/juan-perez.js
```
