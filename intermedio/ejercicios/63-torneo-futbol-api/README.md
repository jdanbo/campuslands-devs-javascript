...
Simular carga de equipos, partidos y tabla desde fuentes asincronas.
...
1. Crear funciones async para cargar datos.
2. Combinar equipos con resultados.
3. Construir tabla.
...
```text
intermedio/ejercicios/63-torneo-futbol-api/resoluciones/juan-perez/juan-perez.js
```
