...
Procesar pedidos con combos, toppings, descuentos y propina.
...
1. Modelar menu y pedido.
2. Calcular subtotal por item.
3. Aplicar descuento si supera minimo.
4. Generar ticket final.
...
```text
intermedio/ejercicios/17-pedidos-foodtruck/resoluciones/juan-perez/juan-perez.js
```
