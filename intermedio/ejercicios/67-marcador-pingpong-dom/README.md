...
Crear marcador interactivo con sets, puntos y ganador.
...
1. Crear estado de partido.
2. Sumar puntos por jugador.
3. Aplicar regla de set.
4. Renderizar ganador.
...
```text
intermedio/ejercicios/67-marcador-pingpong-dom/resoluciones/juan-perez/juan-perez.js
```
