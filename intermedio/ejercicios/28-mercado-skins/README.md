...
Analizar precios historicos de skins y detectar oportunidades de compra.
...
1. Crear historial de precios.
2. Calcular variacion porcentual.
3. Detectar caidas fuertes.
4. Recomendar comprar, esperar o vender.
...
```text
intermedio/ejercicios/28-mercado-skins/resoluciones/juan-perez/juan-perez.js
```
