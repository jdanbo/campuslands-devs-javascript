...
promedios, maximos y alertas

## Contexto

Analizar lecturas de velocidad, rpm y temperatura durante una vuelta de pista.
...
1. Crear lecturas de telemetria por tramo.
2. Calcular velocidad promedio y rpm maxima.
3. Detectar tramos con temperatura peligrosa.
4. Generar alertas legibles.
...
```text
intermedio/ejercicios/06-telemetria-motos/resoluciones/juan-perez/juan-perez.js
```
