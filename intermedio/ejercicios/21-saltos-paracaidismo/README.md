...
riesgo y estadisticas

## Contexto

Registrar saltos y calcular riesgo segun altura, viento y experiencia.
...
1. Crear saltos con altura y viento.
2. Clasificar nivel de riesgo.
3. Calcular altura promedio.
4. Filtrar saltos no recomendados.
...
```text
intermedio/ejercicios/21-saltos-paracaidismo/resoluciones/juan-perez/juan-perez.js
```
