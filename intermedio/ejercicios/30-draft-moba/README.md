...
restricciones y picks

## Contexto

Validar picks y bans para construir un draft competitivo.
...
1. Crear pool de heroes.
2. Aplicar bans.
3. Evitar picks repetidos.
4. Validar roles minimos.
...
```text
intermedio/ejercicios/30-draft-moba/resoluciones/juan-perez/juan-perez.js
```
