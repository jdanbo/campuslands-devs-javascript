...
Simular velocidad aproximada por segundo segun aceleracion.
...
1. Crear parametros del vehiculo.
2. Generar tabla por segundo.
3. Limitar a velocidad maxima.
4. Detectar tiempo 0-100.
...
```text
intermedio/ejercicios/61-simulador-hipercar/resoluciones/juan-perez/juan-perez.js
```
