...
Gestionar progreso de lectura de un grupo y detectar atrasos.
...
1. Crear miembros y libros.
2. Actualizar paginas leidas.
3. Calcular porcentaje por miembro.
4. Listar atrasados.
...
```text
intermedio/ejercicios/40-club-lectura/resoluciones/juan-perez/juan-perez.js
```
