...
Evaluar checklist de calidad y generar dictamen.
...
1. Crear checklist por pieza.
2. Calcular porcentaje cumplido.
3. Detectar fallas criticas.
4. Generar aprobado/rechazado.
...
```text
intermedio/ejercicios/50-inspeccion-soldadura/resoluciones/juan-perez/juan-perez.js
```
