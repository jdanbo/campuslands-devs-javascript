...
ordenamiento por energia

## Contexto

Organizar un setlist con apertura, pico de energia y cierre.
...
1. Crear canciones con energia y duracion.
2. Seleccionar cancion de apertura.
3. Ordenar bloque central.
4. Calcular duracion final.
...
```text
intermedio/ejercicios/38-setlist-concierto/resoluciones/juan-perez/juan-perez.js
```
