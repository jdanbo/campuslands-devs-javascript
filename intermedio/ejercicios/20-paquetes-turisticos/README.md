...
scoring y recomendacion

## Contexto

Comparar paquetes turisticos por precio, duracion, rating y tipo de experiencia.
...
1. Modelar paquetes.
2. Crear funcion de puntuacion.
3. Filtrar por presupuesto.
4. Recomendar mejor paquete.
...
```text
intermedio/ejercicios/20-paquetes-turisticos/resoluciones/juan-perez/juan-perez.js
```
