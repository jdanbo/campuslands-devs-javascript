...
Actualizar rating de jugadores tras partidos usando formula ELO simplificada.
...
1. Crear jugadores con rating.
2. Calcular resultado esperado.
3. Actualizar rating ganador/perdedor.
4. Ordenar ranking.
...
```text
intermedio/ejercicios/37-ranking-pingpong-elo/resoluciones/juan-perez/juan-perez.js
```
