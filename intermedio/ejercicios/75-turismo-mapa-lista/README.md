...
Buscar lugares por nombre, categoria y ciudad.
...
1. Crear buscador.
2. Filtrar lugares en tiempo real.
3. Ordenar por rating.
4. Mostrar detalle seleccionado.
...
```text
intermedio/ejercicios/75-turismo-mapa-lista/resoluciones/juan-perez/juan-perez.js
```
