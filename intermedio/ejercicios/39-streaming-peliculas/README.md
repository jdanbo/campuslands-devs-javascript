...
preferencias y scoring

## Contexto

Recomendar peliculas segun generos preferidos, duracion y rating.
...
```text
intermedio/ejercicios/39-streaming-peliculas/resoluciones/juan-perez/juan-perez.js
```
