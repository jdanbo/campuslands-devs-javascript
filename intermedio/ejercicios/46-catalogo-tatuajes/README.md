...
Filtrar estilos por zona, tamano, dolor estimado y presupuesto.
...
1. Crear estilos y parametros.
2. Filtrar por presupuesto.
3. Clasificar dolor.
4. Recomendar estilos compatibles.
...
```text
intermedio/ejercicios/46-catalogo-tatuajes/resoluciones/juan-perez/juan-perez.js
```
