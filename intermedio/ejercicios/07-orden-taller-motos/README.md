...
estado de procesos y costos

## Contexto

Gestionar ordenes de reparacion con repuestos, mano de obra y estado.
...
1. Modelar ordenes de taller.
2. Calcular subtotal de repuestos y mano de obra.
3. Filtrar ordenes pendientes.
4. Actualizar estado de una orden por id.
...
```text
intermedio/ejercicios/07-orden-taller-motos/resoluciones/juan-perez/juan-perez.js
```
