...
Organizar canciones por energia, genero y duracion para una sesion.
...
1. Crear canciones con genero, bpm y duracion.
2. Filtrar por rango de bpm.
3. Calcular duracion total.
4. Crear nombres normalizados para busqueda.
...
```text
intermedio/ejercicios/13-playlist-dj/resoluciones/juan-perez/juan-perez.js
```
