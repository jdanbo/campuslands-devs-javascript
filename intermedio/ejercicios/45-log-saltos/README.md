...
Analizar evolucion de saltos por mes y condiciones de viento.
...
1. Registrar saltos con fecha.
2. Agrupar por mes.
3. Calcular promedio de viento.
4. Detectar mejor mes.
...
```text
intermedio/ejercicios/45-log-saltos/resoluciones/juan-perez/juan-perez.js
```
