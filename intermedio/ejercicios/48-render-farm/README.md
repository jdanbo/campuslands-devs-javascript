...
colas y tiempo estimado

## Contexto

Distribuir trabajos de render entre nodos con distinta potencia.
...
1. Crear nodos y trabajos.
2. Estimar tiempo por nodo.
3. Asignar trabajo al nodo menos cargado.
...
```text
intermedio/ejercicios/48-render-farm/resoluciones/juan-perez/juan-perez.js
```
