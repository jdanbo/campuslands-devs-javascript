...
Guardar libros y estados de lectura en localStorage.
...
```text
intermedio/ejercicios/71-biblioteca-localstorage/resoluciones/juan-perez/juan-perez.js
```
