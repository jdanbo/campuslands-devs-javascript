...
Gestionar inventario por talla, color y disponibilidad en un lanzamiento.
...
1. Crear productos con tallas y stock.
2. Validar compra segun talla.
3. Descontar stock.
4. Listar productos agotados.
...
```text
intermedio/ejercicios/18-drop-ropa-streetwear/resoluciones/juan-perez/juan-perez.js
```
