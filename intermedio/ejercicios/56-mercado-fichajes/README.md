...
presupuesto y seleccion

## Contexto

Comprar jugadores maximizando rating sin pasar presupuesto.
...
1. Crear jugadores con precio y rating.
2. Filtrar por posicion necesaria.
3. Ordenar por relacion rating/precio.
4. Seleccionar plantilla viable.
...
```text
intermedio/ejercicios/56-mercado-fichajes/resoluciones/juan-perez/juan-perez.js
```
