...
Administrar reservas por horario, mesa y cantidad de personas.
...
1. Crear mesas y reservas.
2. Validar capacidad.
3. Evitar doble reserva.
...
```text
intermedio/ejercicios/41-reservas-restaurante/resoluciones/juan-perez/juan-perez.js
```
