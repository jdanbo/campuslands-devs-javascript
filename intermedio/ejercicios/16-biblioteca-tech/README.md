...
Gestionar libros prestados, disponibles y pendientes de lectura.
...
1. Crear arreglo de libros.
2. Implementar prestar y devolver por id.
3. Filtrar por estado.
4. Calcular porcentaje leido.
...
```text
intermedio/ejercicios/16-biblioteca-tech/resoluciones/juan-perez/juan-perez.js
```
