...
distancias y prioridad

## Contexto

Ordenar atracciones por distancia, horario y prioridad.
...
1. Crear atracciones.
2. Filtrar por horario disponible.
3. Ordenar por prioridad/distancia.
4. Generar ruta del dia.
...
```text
intermedio/ejercicios/44-rutas-turisticas/resoluciones/juan-perez/juan-perez.js
```
