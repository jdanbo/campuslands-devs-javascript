...
Representar zonas de loot en una matriz y calcular mejores zonas.
...
1. Crear matriz de zonas.
2. Calcular loot total por fila/columna.
3. Encontrar coordenada recomendada.
...
```text
intermedio/ejercicios/55-mapa-loot/resoluciones/juan-perez/juan-perez.js
```
