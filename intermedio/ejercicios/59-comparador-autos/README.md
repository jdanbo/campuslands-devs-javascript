...
Comparar autos por consumo, costo, potencia y uso recomendado.
...
1. Crear autos con metricas.
2. Normalizar puntuaciones.
3. Calcular score final.
4. Mostrar ganador por perfil.
...
```text
intermedio/ejercicios/59-comparador-autos/resoluciones/juan-perez/juan-perez.js
```
