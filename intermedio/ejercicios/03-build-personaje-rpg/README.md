...
funciones puras y reglas de negocio

## Contexto

Construir una ficha RPG donde la clase del personaje afecta atributos y habilidades.
...
1. Crear clases de personaje con modificadores.
2. Aplicar bonificaciones sin mutar el objeto original.
3. Validar puntos disponibles.
4. Mostrar ficha final del personaje.
...
```text
intermedio/ejercicios/03-build-personaje-rpg/resoluciones/juan-perez/juan-perez.js
```
