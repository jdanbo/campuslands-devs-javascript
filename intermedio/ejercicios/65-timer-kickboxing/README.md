...
Crear temporizador de rounds y descanso con estados.
...
2. Usar setInterval.
3. Cambiar entre round y descanso.
4. Permitir pausar/reiniciar.
...
```text
intermedio/ejercicios/65-timer-kickboxing/resoluciones/juan-perez/juan-perez.js
```
