...
Cotizar comisiones segun estilo, detalle, uso comercial y tiempo de entrega.
...
1. Crear catalogo de estilos.
2. Calcular precio base.
3. Aplicar extra por urgencia y uso comercial.
4. Generar resumen para cliente.
...
```text
intermedio/ejercicios/23-comisiones-dibujo/resoluciones/juan-perez/juan-perez.js
```
