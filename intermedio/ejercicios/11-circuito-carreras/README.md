...
simulacion y acumulacion

## Contexto

Simular tiempos por vuelta y construir una tabla de posiciones.
...
1. Crear pilotos con tiempos por vuelta.
2. Calcular tiempo total.
3. Detectar vuelta rapida.
4. Ordenar posiciones finales.
...
```text
intermedio/ejercicios/11-circuito-carreras/resoluciones/juan-perez/juan-perez.js
```
