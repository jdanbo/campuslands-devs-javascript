...
Validar datos antes de permitir un salto.
...
1. Crear formulario de check-in.
2. Validar edad, viento y equipo.
3. Mostrar aprobado/rechazado.
4. Guardar registro.
...
```text
intermedio/ejercicios/76-paracaidismo-checkin/resoluciones/juan-perez/juan-perez.js
```
