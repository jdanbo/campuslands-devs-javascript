...
Organizar obras por tecnica, tema, estado y dificultad.
...
1. Crear obras con etiquetas.
2. Buscar por etiqueta.
3. Filtrar terminadas.
4. Calcular dificultad promedio.
...
```text
intermedio/ejercicios/47-portafolio-dibujo/resoluciones/juan-perez/juan-perez.js
```
