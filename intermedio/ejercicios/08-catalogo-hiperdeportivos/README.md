...
Filtrar vehiculos por potencia, precio, pais y aceleracion.
...
1. Crear catalogo de autos.
2. Implementar filtros por rango.
3. Ordenar por aceleracion 0-100.
4. Mostrar el mejor candidato segun presupuesto.
...
```text
intermedio/ejercicios/08-catalogo-hiperdeportivos/resoluciones/juan-perez/juan-perez.js
```
