...
Interpretar comandos tipo terminal para explorar una nave.
...
1. Crear comandos disponibles.
2. Parsear entrada del usuario.
3. Ejecutar acciones segun comando.
4. Mostrar historial.
...
```text
intermedio/ejercicios/70-sci-fi-terminal/resoluciones/juan-perez/juan-perez.js
```
