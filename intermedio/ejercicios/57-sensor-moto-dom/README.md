...
Mostrar tarjetas de sensores y alertas visuales segun valores.
...
1. Crear datos de sensores.
2. Renderizar tarjetas en DOM.
3. Aplicar clase de alerta.
4. Actualizar lectura simulada.
...
```text
intermedio/ejercicios/57-sensor-moto-dom/resoluciones/juan-perez/juan-perez.js
```
