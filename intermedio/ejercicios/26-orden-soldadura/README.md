...
Registrar trabajos de soldadura, materiales, inspector y resultado de calidad.
...
1. Modelar trabajos.
2. Validar amperaje segun material.
3. Calcular tasa de aprobacion.
4. Listar trabajos rechazados.
...
```text
intermedio/ejercicios/26-orden-soldadura/resoluciones/juan-perez/juan-perez.js
```
