...
Relacionar peliculas, planetas, facciones y tecnologia dentro de una saga.
...
1. Crear estructuras para peliculas y facciones.
2. Buscar peliculas por faccion.
3. Contar apariciones por planeta.
4. Generar resumen de universo.
...
```text
intermedio/ejercicios/15-sagas-ciencia-ficcion/resoluciones/juan-perez/juan-perez.js
```
