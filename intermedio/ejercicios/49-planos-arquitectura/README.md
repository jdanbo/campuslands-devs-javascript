...
Gestionar versiones de planos y estados de aprobacion.
...
1. Crear planos con versiones.
2. Obtener version mas reciente.
3. Filtrar pendientes de revision.
4. Marcar aprobado por id.
...
```text
intermedio/ejercicios/49-planos-arquitectura/resoluciones/juan-perez/juan-perez.js
```
