...
modularizacion simple

## Contexto

Separar clientes, motos y ordenes en funciones claras.
...
1. Crear datos base.
2. Implementar funciones de busqueda.
3. Relacionar cliente con moto.
4. Generar reporte de ordenes.
...
```text
intermedio/ejercicios/58-crm-taller/resoluciones/juan-perez/juan-perez.js
```
