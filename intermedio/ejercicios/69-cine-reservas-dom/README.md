...
Seleccionar asientos y calcular total de boletas.
...
1. Crear matriz de asientos.
2. Renderizar asientos.
3. Permitir seleccionar disponibles.
...
```text
intermedio/ejercicios/69-cine-reservas-dom/resoluciones/juan-perez/juan-perez.js
```
