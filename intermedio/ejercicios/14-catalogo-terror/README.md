...
Recomendar peliculas segun nivel de susto, duracion y subgenero.
...
1. Modelar peliculas con subgenero y susto.
2. Filtrar por duracion maxima.
3. Ordenar por nivel de susto.
4. Generar recomendacion personalizada.
...
```text
intermedio/ejercicios/14-catalogo-terror/resoluciones/juan-perez/juan-perez.js
```
