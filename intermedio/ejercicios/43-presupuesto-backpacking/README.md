...
Calcular presupuesto de viaje con transporte, comida, hospedaje y actividades.
...
1. Crear gastos por dia.
2. Agrupar por categoria.
3. Calcular promedio diario.
4. Detectar dias fuera de presupuesto.
...
```text
intermedio/ejercicios/43-presupuesto-backpacking/resoluciones/juan-perez/juan-perez.js
```
