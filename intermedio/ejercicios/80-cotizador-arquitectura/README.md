...
formularios y calculo

## Contexto

Cotizar render arquitectonico segun m2, vistas, calidad y urgencia.
...
```text
intermedio/ejercicios/80-cotizador-arquitectura/resoluciones/juan-perez/juan-perez.js
```
