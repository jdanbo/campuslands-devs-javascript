...
drag mental y prioridades

## Contexto

Organizar actividades en dias con presupuesto y prioridad.
...
1. Crear actividades.
2. Asignar a dias.
3. Calcular costo por dia.
4. Alertar exceso de presupuesto.
...
```text
intermedio/ejercicios/74-planner-viajes/resoluciones/juan-perez/juan-perez.js
```
