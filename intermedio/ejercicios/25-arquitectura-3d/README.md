...
Evaluar renders arquitectonicos por iluminacion, materiales, escala y entrega.
...
1. Crear renders con criterios.
2. Calcular nota promedio.
3. Detectar criterios bajo minimo.
4. Ordenar renders por calidad.
...
```text
intermedio/ejercicios/25-arquitectura-3d/resoluciones/juan-perez/juan-perez.js
```
