...
acumuladores y decisiones

## Contexto

Calcular ganador por rounds usando golpes, derribos y penalizaciones.
...
1. Modelar rounds por peleador.
2. Calcular puntos por round.
...
```text
intermedio/ejercicios/10-marcador-kickboxing/resoluciones/juan-perez/juan-perez.js
```
