...
Crear una interfaz simple para registrar mensajes de estrategia.
...
1. Crear HTML minimo si lo necesitas.
2. Agregar mensajes al DOM.
3. Validar mensaje no vacio.
4. Filtrar mensajes por rol.
...
```text
intermedio/ejercicios/54-chat-equipo-moba/resoluciones/juan-perez/juan-perez.js
```
