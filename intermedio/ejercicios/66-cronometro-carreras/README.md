...
Registrar tiempos de vuelta desde botones y calcular mejores marcas.
...
1. Crear botones de iniciar/vuelta/reset.
2. Guardar tiempos.
3. Calcular mejor vuelta.
4. Mostrar historial.
...
```text
intermedio/ejercicios/66-cronometro-carreras/resoluciones/juan-perez/juan-perez.js
```
