...
acumulacion por jornadas

## Contexto

Simular una temporada corta y actualizar tabla de posiciones.
...
1. Crear equipos.
2. Procesar resultados de jornadas.
3. Actualizar puntos, goles y diferencia.
...
```text
intermedio/ejercicios/32-temporada-futbol/resoluciones/juan-perez/juan-perez.js
```
