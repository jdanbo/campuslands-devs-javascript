...
Agregar resultados desde un formulario y actualizar tabla de posiciones.
...
1. Crear formulario de resultado.
2. Validar goles numericos.
3. Actualizar tabla en memoria.
4. Renderizar posiciones.
...
```text
intermedio/ejercicios/64-posiciones-futsal-dom/resoluciones/juan-perez/juan-perez.js
```
