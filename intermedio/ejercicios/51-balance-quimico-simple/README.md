...
Comparar reactivos y productos en ecuaciones simples ya separadas.
...
1. Recibir conteos de elementos por lado.
2. Comparar cantidades por elemento.
3. Detectar elementos desbalanceados.
...
```text
intermedio/ejercicios/51-balance-quimico-simple/resoluciones/juan-perez/juan-perez.js
```
