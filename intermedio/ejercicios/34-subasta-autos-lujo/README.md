...
Procesar ofertas por vehiculo y determinar ganadores validos.
...
1. Crear autos y ofertas.
2. Validar oferta minima.
3. Agrupar ofertas por auto.
4. Seleccionar ganador por monto.
...
```text
intermedio/ejercicios/34-subasta-autos-lujo/resoluciones/juan-perez/juan-perez.js
```
