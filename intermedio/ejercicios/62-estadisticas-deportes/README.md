...
Unificar estadisticas de varios deportes en una sola tabla comparable.
...
1. Crear registros de deportes distintos.
2. Normalizar campos comunes.
3. Calcular rendimiento por atleta.
4. Ordenar ranking general.
...
```text
intermedio/ejercicios/62-estadisticas-deportes/resoluciones/juan-perez/juan-perez.js
```
