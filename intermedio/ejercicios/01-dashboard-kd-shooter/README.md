...
arrays de objetos, calculos y ranking

## Contexto

Analizar estadisticas de una squad competitiva y ordenar jugadores por rendimiento.
...
1. Crear un arreglo de jugadores con bajas, muertes y asistencias.
2. Calcular K/D y participacion por jugador.
3. Ordenar el ranking de mayor a menor K/D.
4. Mostrar un resumen general del equipo.
...
```text
intermedio/ejercicios/01-dashboard-kd-shooter/resoluciones/juan-perez/juan-perez.js
```
