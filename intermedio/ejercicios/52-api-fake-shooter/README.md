...
fetch simulado y errores

## Contexto

Simular consulta de estadisticas remotas con promesas y manejo de errores.
...
1. Crear funcion fakeFetchStats.
2. Resolver datos despues de un tiempo.
3. Manejar error si jugador no existe.
4. Mostrar resultado con async/await.
...
```text
intermedio/ejercicios/52-api-fake-shooter/resoluciones/juan-perez/juan-perez.js
```
