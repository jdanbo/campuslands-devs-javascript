...
simulacion por fases

## Contexto

Calcular dano de zona y supervivencia durante varias fases.
...
1. Crear jugadores con vida y posicion.
2. Simular fases de zona.
3. Aplicar dano a jugadores fuera de zona.
4. Mostrar sobrevivientes.
...
```text
intermedio/ejercicios/31-zona-battle-royale/resoluciones/juan-perez/juan-perez.js
```
