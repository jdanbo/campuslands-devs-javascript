...
estadisticas ponderadas

## Contexto

Construir un ranking de jugadores usando goles, asistencias, pases clave y tarjetas.
...
1. Modelar jugadores con estadisticas.
2. Crear una formula de puntuacion ponderada.
3. Penalizar tarjetas amarillas y rojas.
4. Ordenar y mostrar top 5.
...
```text
intermedio/ejercicios/05-ranking-futbol-pro/resoluciones/juan-perez/juan-perez.js
```
