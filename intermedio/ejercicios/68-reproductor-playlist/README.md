...
Simular un reproductor con siguiente, anterior, shuffle y favorito.
...
2. Mantener indice actual.
3. Implementar siguiente/anterior.
4. Marcar favoritos.
...
```text
intermedio/ejercicios/68-reproductor-playlist/resoluciones/juan-perez/juan-perez.js
```
